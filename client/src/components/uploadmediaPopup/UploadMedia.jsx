...
const UploadMedia = ({ openPopup, setOpenPopup, fetchAllMedia }) => {
      ...
      await fetch("https://api.cloudinary.com/v1_1/dbnqqpobe/image/upload", {
        ...
        .then(async (data) => {
          ...
          const response = await axios.post(
            `http://localhost:3001/api/image/uploadmedia`,
            {
          ...
          if (response.data.success === true) {
            setLoading(false);
            closeDialog();
            fetchAllMedia(); //to update the homepage with the new uploaded image
          }
        })
        .catch((err) => {
          console.log(err);
            ...
            <div className="upload_right__section">
              ...
              <div>
                ...
                <textarea
                  ...
                  id=""
                  onChange={onChange}
                  value={userInputs.story}
                ></textarea>
              </div>
              <button onClick={uploadAndSaveImage}>
